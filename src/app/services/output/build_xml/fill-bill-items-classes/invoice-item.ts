...
export class InvoiceItem {
  ...
  public populate(f: Factura, cargo: Cargo[]) {
    ...
    this.RegNum = f.name;
    this.RegDate = f.date;
    this.DopData1 = f.footer_first_str;
    ...
    this.GCost = f.grand_total;
    this.OtherCharges = f.extra_total;
    this.OtherChargesName = f.extra_total_description;
    this.TotalCost = f.total_amount;

    this.Buyer_OKPO = f.buyer.okpo;
    this.Buyer_INN = f.buyer.inn;
    this.Buyer_Name = f.buyer.name;
    this.Buyer_Phone = f.buyer.phone;
    this.Buyer_PostalCode = f.buyer.postal_code;
